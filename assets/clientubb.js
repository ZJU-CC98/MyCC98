...
var codeUbb = function(source,language){
	...
	source ='<table style="width:100%" cellpadding=5 cellspacing=1 class=tableborder1><tr><TD class="'+tdclass+'" width="100%" onDblClick="copy2cb(ubb.storage.codeSource[\''+ubb.num['code'].toString()+'\'])"><div style="overflow:auto;"><p style="font:'+fo+'">' + strf + '</p></div></td></tr></table>';
	return source;
}
	...
	media:function(str){
		...
		if(canmediacode){
			...
			if(ubb.num['musicAuto'] < 1){
				...
				if(pattern.test(str)) {
				str = str.replace(/\[mp3=1\](.[^\[\'\"\(\)]*)\[\/mp3\]/i, '<div style="height:20px; width:240px;border:1px #e4e8ef solid;"><embed src="http://www.cc98.org/inc/mp3player.swf" width="240" height="20" type="application/x-shockwave-flash" quality="high" flashvars="mp3=$1&autoplay=1&showtime=1"></embed></object></div>');
				ubb.num['musicAuto']++;
				}
			}
			str = str.replace(/\[mp3\](.[^\[\'\"\(\)]*)\[\/mp3\]/gi, '<div style="height:20px; width:240px;border:1px #e4e8ef solid;"><embed src="http://www.cc98.org/inc/mp3player.swf" width="240" height="20" type="application/x-shockwave-flash" quality="high" flashvars="mp3=$1&autoplay=0&showtime=1"></embed></object></div>');
			//end mp3 player
			//CC98 Share media
			...
			str= str.replace(/(\[FLASH\])(.[^\[\'\"\(\)]*)(\[\/FLASH\])/gi,"<a href=\"$2\" TARGET=_blank><IMG SRC=http://www.cc98.org/pic/swf.gif border=0 alt=点击开新窗口欣赏该FLASH动画! height=16 width=16>[全屏欣赏]</a><BR><object classid=\"clsid:d27cdb6e-ae6d-11cf-96b8-444553540000\" codebase=\"http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0\" width=\"500\" height=\"400\" align=\"middle\"><param name=\"allowScriptAccess\" value=\"always\" /><param name=\"movie\" value=\"$2\" /><param name=\"quality\" value=\"high\" /><param name=\"wmode\" value=\"transparent\" /><param name=\"devicefont\" value=\"true\" /><embed src=\"$2\" quality=\"high\" wmode=\"transparent\" devicefont=\"true\" width=\"500\" height=\"400\" swLiveConnect=true align=\"middle\" allowScriptAccess=\"always\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" /></object>");
