...
public class CC98ParseRepository {
	...
	public static final String POST_CONTENT_WHOLE_REGEX="(?<=glow\\(color=#9898BA,strength=2).*?(?=align=absmiddle></a>)";
	public static final String POST_CONTENT_POST_CONTENT_REGEX = "(?<=</b><br>).*?</script>";
	public static final String POST_CONTENT_USER_AVATAR_LINK_REGEX = "(?<=<img src=\")pic/anonymous.gif\"|(?<= ><img src=).*?(?= )|(?<=&nbsp;<img src=\").*?(?=\" border=0 ><br>)";
